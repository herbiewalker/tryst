...
object Achievements {
    ...
    val catalog: List<AchievementDef> = listOf(
        ...
        AchievementDef("v_kinks5", "Curious", "Explore 5 different kinks.", AchievementCategory.VARIETY, 5, "😈", Distinct { e, _ -> e.encounter.kinks ?: emptySet() }),
        AchievementDef("v_kinks10", "Kinkster", "Explore 10 different kinks.", AchievementCategory.VARIETY, 10, "🖤", Distinct { e, _ -> e.encounter.kinks ?: emptySet() }),
        AchievementDef("v_kinks25", "Deviant", "Explore 25 different kinks.", AchievementCategory.VARIETY, 25, "🔥", Distinct { e, _ -> e.encounter.kinks ?: emptySet() }),
        AchievementDef("v_toys5", "Toy Box", "Use 5 different toys.", AchievementCategory.VARIETY, 5, "🧸", Distinct { e, _ -> e.encounter.toys ?: emptySet() }),
