...
[![Release](https://img.shields.io/badge/release-v0.5.3-success)](CHANGELOG.md)
...
✅ **Shipped.** Current release **v0.5.3** (versionCode 10, schema v16). Distribution is **F-Droid**,
...
| [DATA_MODEL.md](docs/DATA_MODEL.md) | Entities & fields (schema v16) |
