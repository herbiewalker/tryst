...
[![Release](https://img.shields.io/badge/release-v0.5.4-success)](CHANGELOG.md)
...
✅ **Shipped.** Current release **v0.5.4** (versionCode 11, schema v16). Distribution is **F-Droid**,
