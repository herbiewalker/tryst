...
PRACTICE = ["KISSING", "MAKING_OUT", "ORAL", "BLOWJOB", "BALL_SUCKING", "CUNNILINGUS",
            "LICK_PUSSY_AFTER", "CLIT_SUCKING", "DEEP_THROAT", "SIXTY_NINE", "RIMMING",
            "FACE_FUCKING", "MANUAL",
            ...
            "MASSAGE", "MUTUAL_MASTURBATION", "MASTURBATION", "SPIT_PLAY",
            "CREAMPIE", "EAT_OWN_CREAMPIE", "ANAL_CREAMPIE", "FACIAL", "SQUIRTING", "CUDDLING", "OTHER"]
KINK = ["DOMINATION", "SUBMISSION", "BONDAGE", "ROPE_BONDAGE", "RESTRAINTS", "IMPACT_PLAY",
        ...
        "ROLEPLAY", "COSTUME_PLAY", "DIRTY_TALK", "TANTRIC", "VOYEURISM", "WATCHING_PORN", "EXHIBITIONISM",
...
for p in ["ANAL", "ANAL_FINGERING", "ANAL_CREAMPIE", "ASS_TO_MOUTH", "DOUBLE_PENETRATION",
          ...
          "SPIT_PLAY", "FACIAL"]:
    PRACTICE_TIER[p] = 3
SOLO_PRACTICE = ["MASTURBATION", "OTHER", "FOOT_PLAY", "NIPPLE_PLAY"]
