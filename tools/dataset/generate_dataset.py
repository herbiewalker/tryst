...
PRACTICE = ["KISSING", "MAKING_OUT", "ORAL", "BLOWJOB", "BALL_SUCKING", "CUNNILINGUS",
            "CLIT_SUCKING", "DEEP_THROAT", "SIXTY_NINE", "RIMMING", "FACE_FUCKING", "MANUAL",
            "FINGERING", "ANAL_FINGERING", "VAGINAL", "ANAL", "ASS_TO_MOUTH",
            "DOUBLE_PENETRATION", "PEGGING", "FISTING", "SCISSORING", "PROSTATE_MASSAGE",
            "FROTTAGE", "FACE_SITTING", "NIPPLE_PLAY", "BREAST_PLAY", "TITJOB", "FOOT_PLAY",
            "MASSAGE", "MUTUAL_MASTURBATION", "MASTURBATION", "WATCHING_PORN", "SPIT_PLAY",
            "CREAMPIE", "ANAL_CREAMPIE", "FACIAL", "SQUIRTING", "CUDDLING", "OTHER"]
KINK = ["DOMINATION", "SUBMISSION", "BONDAGE", "ROPE_BONDAGE", "RESTRAINTS", "IMPACT_PLAY",
        "SPANKING", "FLOGGING", "CHOKING", "HAND_ON_NECK", "HAIR_PULLING", "GAGGING",
        "BITING", "SCRATCHING", "MARKING", "FACE_SLAPPING", "SPITTING", "BLINDFOLD",
        "SENSORY_PLAY", "SENSATION_PLAY", "WAX_PLAY", "TEMPERATURE_PLAY", "ELECTROSTIM",
        "EDGING", "ORGASM_CONTROL", "OVERSTIMULATION", "CHASTITY", "CBT", "PRAISE",
        "DEGRADATION", "HUMILIATION", "FINANCIAL_DOMINATION", "COLLARING", "PET_PLAY",
        "ROLEPLAY", "COSTUME_PLAY", "DIRTY_TALK", "TANTRIC", "VOYEURISM", "EXHIBITIONISM",
        "THREESOME", "GROUP_SEX", "SWINGING", "CUCKOLDING", "HOTWIFE", "WATERSPORTS",
        "CUM_PLAY", "CREAMPIE_EATING", "CUM_KISSING", "CUM_SWAPPING", "AFTERCARE"]
SETTING = ["HOME", "BEDROOM", "LIVING_ROOM", "KITCHEN", "BATHROOM", "SHOWER", "BATH",
           "BALCONY", "BACKYARD", "ROOFTOP", "CAR", "HOTEL", "AIRBNB", "VACATION", "OUTDOORS",
...
POSITION = ["MISSIONARY", "DOGGY_STYLE", "COWGIRL", "REVERSE_COWGIRL", "SPOONING",
            ...
            "FACE_SITTING", "KNEELING_ORAL", "STANDING_ORAL", "LYING_ORAL", "ORAL_69_SIDE",
            "ORAL_THRONE", "SPIT_ROAST", "SANDWICH", "DAISY_CHAIN", "EIFFEL_TOWER",
            "TABLE_TOP", "CHAIR", "OTHER"]
...
for k in ["PRAISE", "AFTERCARE", "DIRTY_TALK", "ROLEPLAY", "BITING", "SCRATCHING", "MARKING",
          "HAIR_PULLING", "HAND_ON_NECK", "BLINDFOLD", "SENSORY_PLAY", "SENSATION_PLAY",
          "TANTRIC", "COSTUME_PLAY", "EDGING", "TEMPERATURE_PLAY"]:
    KINK_TIER[k] = 2
for k in ["SUBMISSION", "DOMINATION", "SPANKING", "RESTRAINTS", "BONDAGE", "CHOKING",
          "GAGGING", "ORGASM_CONTROL"]:
    KINK_TIER[k] = 2  # common-enough kinks live at tier 2

PRACTICE_TIER = {p: 1 for p in PRACTICE}
for p in ["ANAL", "ANAL_FINGERING", "ANAL_CREAMPIE", "ASS_TO_MOUTH", "DOUBLE_PENETRATION",
          "PEGGING", "FISTING", "RIMMING", "FACE_FUCKING", "DEEP_THROAT", "PROSTATE_MASSAGE",
          "SPIT_PLAY", "FACIAL"]:
    PRACTICE_TIER[p] = 3
SOLO_PRACTICE = ["MASTURBATION", "WATCHING_PORN", "OTHER", "FOOT_PLAY", "NIPPLE_PLAY"]
